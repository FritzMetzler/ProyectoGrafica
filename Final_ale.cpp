...
>>>>>>> main
		...
		*/
		...
		//________________________________________________________________________________________________________
		//________________________________________ DINO __________________________________________________________
		//________________________________________________________________________________________________________
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(-1.3f, 10.6f, 0.0f));
		model = glm::scale(model, glm::vec3(10.0f));
		staticShader.setMat4("model", model);
		dino_pata_der.Draw(staticShader);

		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(1.4f, 10.2f, 0.6f));
		model = glm::scale(model, glm::vec3(10.0f));
		staticShader.setMat4("model", model);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 11.2f, -3.6f));
		model = glm::scale(model, glm::vec3(10.0f));
		staticShader.setMat4("model", model);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(-1.5f, 11.2f, 8.5f));
		model = glm::scale(model, glm::vec3(10.0f));
		staticShader.setMat4("model", model);
		dino_brazo_der.Draw(staticShader);

		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(1.4f, 11.6f, 8.5f));
		model = glm::scale(model, glm::vec3(10.0f));
		staticShader.setMat4("model", model);
		dino_brazo_izq.Draw(staticShader);
		*/
